...
-- 상품 테스트 데이터
INSERT INTO product (id, name, description, price, stock, brand_id, like_count, created_at, updated_at)
VALUES 
    -- 나이키 상품 (좋아요 수는 실제 데이터와 맞춤)
    (1, '나이키 에어맥스', '편안한 운동화', 150000, 100, 1, 3, '2024-01-01 10:00:00', NOW()),
    (2, '나이키 조던', '농구화', 200000, 50, 1, 2, '2024-01-02 10:00:00', NOW()),
    (3, '나이키 런닝화', '가벼운 런닝화', 120000, 80, 1, 0, '2024-01-03 10:00:00', NOW()),
    
    -- 아디다스 상품
    (4, '아디다스 울트라부스트', '쿠션 좋은 운동화', 180000, 60, 2, 1, '2024-01-04 10:00:00', NOW()),
    (5, '아디다스 스탠스미스', '클래식 스니커즈', 90000, 120, 2, 0, '2024-01-05 10:00:00', NOW()),
